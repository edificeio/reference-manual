...
link:http://opendigitaleducation.com[Open Digital Education] (ODE) Framework aims at providing a modular toolkit to design, build and execute applications in education's field.
