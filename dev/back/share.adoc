...
// TODO Link to link:/dev/front/index.adoc[client dev]
...
WARNING: You must declare a SQL configuration for use it in your verticule class
...
NOTE: $schema is schema of the application and $resourceTable$ is replaced by the name of the table that contains the resources
...
// TODO reference link:/dev/back/data-storage.adoc[Data Storage]
